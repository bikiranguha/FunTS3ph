...
event1_flag = '-event01'
event1_param = '1,FAULTON,ABCG,153,,,,1.0e-6,1.0e-6,1.0e-6,0.0,0.0,0.0'

event2_flag = '-event02'
event2_param = '1.01,FAULTOFF,ABCG,153,,,,,,,,,'
...
call_string = ['./TS3ph', event1_flag, event1_param,event2_flag, event2_param, event3_flag, event3_param]
try:
